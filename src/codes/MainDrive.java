...
//			2. 774 등 중복된 숫자는 막아야함. => 뽑힌 랜덤 숫자가 문제 숫자 안에 들어있는지 (사용해도 되는지) 검사.
...
//					다음 숫자를 뽑으러 가야함. => while 반복을 깨야, 다음 for 차례로 이동.
					break;
				}
...
//		몇번 입력해야 3S가 될까? => 반복 횟수가 불명확한 반복. => 무한 while문으로 활용.
...
//			0번칸 : 123 => 1이 들어가야. 어떻게? 입력값을 100으로 나눈값.
